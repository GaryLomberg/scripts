...
# Create window for misc
tmux new-window -t "$session_name" -n "$mic_window"

tmux send-keys -t "$session_name:$misc_window.0" "source dj_manage $project_name check" C-m
